...
library(knitr)
opts_chunk$set(cache=FALSE, fig.path='../../figure/03.05_maizeMapFig_ln/')
```
...
```{r tauMap_cornPercent, fig.width = 6.5, fig.height = 4.5, dpi = 600}
...
```{r cateHist_cornOnly_percent, dev = c('png','pdf'), dpi = 300, fig.width = 2.65, fig.height = 1.75, bg="transparent"}
